...
1. **[Fine-tuning Básico](../fine_tuning_basics/)** - Personalizar modelos para tu dominio
2. **[Evaluación de Modelos](../model_evaluation/)** - Métricas y benchmarks
3. **[LLMs en Producción](../llms_kubernetes/)** - Despliegue a escala
