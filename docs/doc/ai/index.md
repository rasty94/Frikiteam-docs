...
1. [Introducción a LLMs](llms_fundamentals.md) - Conceptos básicos
2. [Ollama: primeros pasos](ollama_basics.md) - Tu primera instalación
3. [Evaluación de modelos](model_evaluation.md) - Cómo medir rendimiento
